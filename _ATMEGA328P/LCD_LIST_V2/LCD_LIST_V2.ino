...
const char filename1[] = "YELLOW.txt";
const char filename2[] = "BLUE.txt";
const char filename3[] = "RED.txt";

File txtFile, yellowFile, blueFile, redFile;
typedef enum {
  RED,
  YELLOW,
  BLUE
...
void setup() {
  ...
  // rtc.setTime(21, 35, 30);    // Set the t to 12:00:00 (24hr format)
